...
class LAModel(db.Model):
    ...
    ASSET=db.Column(db.String(100))
    CONS_TYPE=db.Column(db.String(100))
    ARUS_NOM_DISCH=db.Column(db.Float(100))
    GAP_TYPE=db.Column(db.String(100))
    CLASS_DISCH=db.Column(db.Float(100))
    MCOV=db.Column(db.Float(100))
    JENIS=db.Column(db.String(100))
    MTRL_OKSIDA=db.Column(db.String(100))
    TEG_NOM=db.Column(db.Float(100))
    TEG_RATING=db.Column(db.Float(100))
    ARUS_DISCH_MAX=db.Column(db.Float(100))
    BIL=db.Column(db.Float(100))
    RESIDUAL_5KA=db.Column(db.Float(100))
    RESIDUAL_10KA=db.Column(db.Float(100))
    RESIDUAL_20KA=db.Column(db.Float(100))
    TINGGI=db.Column(db.Float(100))
    BERAT=db.Column(db.Float(100))
    STANDART=db.Column(db.String(100))
    PASANGAN=db.Column(db.String(100))
    STACK=db.Column(db.Float(100))
    TYPE_ID=db.Column(db.String(100))
    CCODE=db.Column(db.Integer)